...
class TestJuiceShopMonitor(unittest.TestCase):
        ...
        self.mock_config = {
            ...
            "monitoring": {
                "juice_shop_monitoring": {
                    ...
                    # These are hardcoded in the monitor, but we test against them
    ...
    def test_analyze_line_brute_force(self):
        ...
        """
        # --- Arrange ---
        log_line = '::ffff:1.2.3.4 - - [22/Oct/2025:15:30:00 +0000] "POST /rest/user/login HTTP/1.1" 401 139'
    ...
    def test_analyze_line_sql_injection(self):
        ...
        log_line = '::ffff:2.3.4.5 - - [22/Oct/2025:15:31:00 +0000] "GET /api/Products?search=\' UNION SELECT 1,2,name,4,5,6,7,8,9 FROM Users-- HTTP/1.1" 200 1205'
    ...
    def test_analyze_error_spike(self):
        ...
        """
        # --- Arrange ---
        log_line = '::ffff:3.4.5.6 - - [22/Oct/2025:15:32:00 +0000] "POST /api/Users HTTP/1.1" 500 78'
